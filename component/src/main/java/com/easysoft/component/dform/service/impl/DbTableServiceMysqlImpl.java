...
import com.easysoft.component.dform.model.CgFormFieldEntity;
import com.easysoft.component.dform.model.CgFormHeadEntity;
import com.easysoft.component.dform.service.DbTableServiceI;
import com.easysoft.component.dform.utils.DbTableUtil;
import com.easysoft.component.dform.utils.FieldNumComparator;
...
public class DbTableServiceMysqlImpl implements DbTableServiceI {
	...
	public String updateTableSQL(CgFormHeadEntity cgFormHead, JdbcTemplate jdbcTemplate) {
		String sql = "select column_name,data_type,column_comment,numeric_precision,numeric_scale,character_maximum_length," +
				"is_nullable nullable from information_schema.columns where table_name =  '"+cgFormHead.getTableName()+"'and table_schema = 'sys';";
	...
	public String createIsExitSql(String tableName) {
		return "SELECT COUNT(*) FROM information_schema.TABLES WHERE TABLE_NAME='"+tableName+"' and table_schema = 'sys';";
	}
