package com.easysoft.tag.webapp.taglib.easyui;
...
import com.easysoft.tag.utils.TagUtil;
import com.easysoft.tag.webapp.taglib.easyui.vo.ColumnValue;
import com.easysoft.tag.webapp.taglib.easyui.vo.DataGridColumn;
import com.easysoft.tag.webapp.taglib.easyui.vo.DataGridUrl;
import com.easysoft.tag.webapp.taglib.easyui.vo.OptTypeDirection;
		...
		if (!StringUtils.isBlank(dictionary)) {
			if(dictionary.contains(",")){
				...
				String sql = "select " + dic[1] + " as field," + dic[2]
						+ " as text from " + dic[0];
				systemService = SpringContextHolder.getBean(
						SystemService.class);
