...
<%@ page import="com.easysoft.framework.ParamSetting" %>
<%
String runmode = ParamSetting.RUNMODE;
%>
...
(function(a){function c(){var b=a("#loading");if(b.size()==0)b=a('<div id="loading" class="loading" style=\'z-index:3000\' />').appendTo(a("body")).hide();return b}a.Loading=a.Loading||{};a.Loading.show=function(b){var d=c();b&&d.html(b);a('<div style="height: 100%; width: 100%; position: fixed; left: 0pt; top: 0pt; z-index: 2999; opacity: 0.4;" class="jqmOverlay"></div>').appendTo(a("body"));d.show()};a.Loading.hide=function(){c().hide();a(".jqmOverlay").remove()}})(jQuery);
  function do_install(str){
    if( $.tirm( ('#ipt_uname').val() )==''){
      alert('管理员用户名不能为空。');
      return false;
    }
    if( $.tirm( ('#ipt_passwd').val() )==''){
        alert('管理员密码不能为空。');
        return false;
      }
...
<div style="padding-left: 45px;"><h5 class="success"><br>请在下面建立管理员帐户：</h5></div>
<div id="show">
<form  action="install.${ext }?installSuccess" method="post" id="installFrm">
...
<table>
  ...
  <tr>
    ...
    <td width="200px">
		<select name="productid">
			...
			<option value="simple">网络商店示例</option>
			<option value="company">企业网站示例</option>			
		</select>  	
	</td>
    <th align="right"> <a href="http://www.easysoft.com.cn/solution.html" target="_blank">下载更多方案</a> </th>
    <td>
    </td>
  </tr> 
    <%} %>
  <tr>
    ...
    <td width="200px"><input type="text" tabindex="2" value="admin" id="ipt_uname" name="username"></td>
    <th align="right"> </th>
    <td>
    </td>
  </tr>
  <tr>
    ...
    <td><input type="password" tabindex="3" id="ipt_passwd" name="password"></td>
    <th align="right"> </th>
    <td>
    </td>
  </tr>
