	...
	<form name="objForm" method="post" id="objForm">
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="roleName"	type="text" id="roleName" ltype="text" validate="{required:true}"/></td>
				<td align="left"></td>
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td" valign="top">状态:</td>
				<td align="left" class="l-table-edit-td">
					<input id="rbtnl_0" type="radio" name="status" value="ACTIVE" checked="checked" /><label for="rbtnl_0">有效</label> 
					<input id="rbtnl_1" type="radio" name="status" value="INACTIVE" /><label for="rbtnl_1">无效</label>
				</td>
				<td align="left"></td>
			</tr>
		</table>
