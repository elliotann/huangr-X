...
<div class="dataTables_wrapper" id="example_wrapper">
    ...
    <table cellspacing="0" cellpadding="0" border="0" id="example" class="sTable2">
        ...
        <tr>
            <th class="head0 sorting_asc" rowspan="1" colspan="1" style="width: 245px;">Rendering engine</th>
            <th class="head1 sorting" rowspan="1" colspan="1" style="width: 368px;">Browser</th>
            <th class="head0 sorting" rowspan="1" colspan="1" style="width: 339px;">Platform(s)</th>
            <th class="head1 sorting" rowspan="1" colspan="1" style="width: 209px;">Engine version</th>
            <th class="head0 sorting" rowspan="1" colspan="1" style="width: 150px;">CSS grade</th>
        </tr>
        </thead>
        <colgroup>
            <col class="con0">
    ...
    <div class="dataTables_info" id="example_info">显示 1 至 10 总共 51 条</div>
