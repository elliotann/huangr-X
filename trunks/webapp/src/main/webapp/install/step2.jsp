...
<form id="db_setting" action="install.${ext }?step3" method="post" onsubmit="return checkInput();">
	<table border="0" width="100%">
		<tbody>
			...
			<tr>
				...
				<td width="48%">如果数据库服务器与WEB服务器不在同一台主机上,请设置为数据库服务器的地址。</td>
			</tr>
			<tr>
				<th align="right" scope="row"><label>数据库用户名:</label></th>
				<td><input type="text" value="" size="25" name="userName" class="txt" id="db_uname" /></td>
			...
			<tr>
				...
				<td><input type="password" value="" size="25" name="password" class="txt" id="db_passwd"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td width="48%">全域名如:www.easysoft.com，不要带端口号</td>
			</tr>
			<tr>
...
function checkAndSubmit(){
	...
	var options = {
		url :"install.${ext}?testConnection",
		cache:false,
		type : "POST",
		dataType : 'json',
