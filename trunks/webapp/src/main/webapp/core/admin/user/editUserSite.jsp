...
<table cellspacing="0" cellpadding="0" border="0" width="100%"
	...
	<tbody>
		<tr>
			<th>网站名称：<input type="hidden" name="site.id"  value="${eopSite.id }" /></th>
			<td>
			<input type="text" name="site.sitename"
			value="${eopSite.sitename }" dataType="string" isrequired="true" style="width:325px"/></td>
		</tr>
		<tr>
			<th>网站标题：</th>
			<td>
			<input type="text" name="site.title"
			value="${eopSite.title }" dataType="string" isrequired="true" style="width:325px"/></td>
		</tr>
		<tr>
			<th><label class="text">META_KEYWORDS：<br/>
				(页面关键词)：</label></th>
			<td>
			<input type="text" name="site.keywords"
		...
		<tr>
			<th><label class="text">META_DESCRIPTION：<br/>
					(页面描述)</label></th>
			<td>
			<textarea name="site.descript" style="width:405px"/>${eopSite.descript }</textarea></td>
		</tr>
		<tr>
			<th>版权声明：</th>
			<td>
			<textarea name="site.copyright" style="width:405px"/><c:out value="${eopSite.copyright }" escapeXml="true"/></textarea></td>
		</tr>
	</tbody>
</table>
</div>
...
<table cellspacing="0" cellpadding="0" border="0"
	...
	<tbody>
		<tr>
			...
			<input type="text" name="site.username"
			value="${eopSite.username }" dataType="string" isrequired="true" style="width: 133px"></td>
			<th style="width: 102px">是否开启：</th>
			<td>
			<input type="radio" name="site.state" namespace="state" id="eopsitekfon0"
		...
		<tr>
			...
			<td style="width:230px"><input type="radio" name="site.usersex" namespace="usersex" id="eopsiteusersex0"
				default="0" <c:if test="${eopSite.usersex==0 }">checked="checked"</c:if> value="0"><label
				for="eopsiteusersex0">男</label>&nbsp;<input type="radio"
				name="site.usersex" id="eopsiteusersex1"
			...
			<td>
			<input style="float:left" type="checkbox" value="1" name="site.qq" <c:if test="${eopSite.qq == 1 }">checked</c:if> />&nbsp;&nbsp;
			<input type="text" vtype="text"
				name="site.qqlist" value="${eopSite.qqlist }" style="width: 143px;">&nbsp;&nbsp;<span class="help_icon" helpid="qq_format"></span></td>
		</tr>
		...
		<tr>
			...
			<td style="width:230px">
			<input type="text" vtype="text"
				name="site.usertel" value="${eopSite.usertel }" style="width: 133px">
			</td>
			<th style="width: 102px">MSN：</th>
			<td>
			<input style="float:left" type="checkbox" value="1" name="site.msn" <c:if test="${eopSite.msn == 1 }">checked</c:if> />&nbsp;&nbsp;
			<input type="text" vtype="text"
				name="site.msnlist" value="${eopSite.msnlist }" style="width: 143px;">&nbsp;&nbsp;<span class="help_icon" helpid="msn_format"></span></td>
		</tr>
		<tr>
			<th style="width: 100px">手机：</th>
			<td style="width:230px">
			<input type="text" vtype="text"
				name="site.usermobile" value="${eopSite.usermobile }" style="width: 133px"></td>
			<th style="width: 102px">旺旺：</th>
			<td>
			<input style="float:left" type="checkbox" value="1" name="site.ww" <c:if test="${eopSite.ww == 1 }">checked</c:if> />&nbsp;&nbsp;
			<input type="text" vtype="text"
				name="site.wwlist" value="${eopSite.wwlist }" style="width: 143px;">&nbsp;&nbsp; <span class="help_icon" helpid="ww_format"></span>
			</td>
		</tr>
		<tr>
			...
			<td style="width:230px">
			<input type="text" vtype="text"
				name="site.usertel1" value="${eopSite.usertel1 }" style="width: 133px"></td>
			<th style="width: 102px">电话：</th>
			<td>
			<input type="checkbox" value="1" name="site.tel" <c:if test="${eopSite.tel == 1 }">checked</c:if> />&nbsp;&nbsp;
			<input type="text" vtype="text"
				name="site.tellist" value="${eopSite.tellist }" style="width: 163px"></td>
		</tr>
		<tr>
			<th style="width: 100px">电子邮件：</th>
			<td style="width:230px">
			<input type="text" vtype="text" isrequired="true" datatype="email"
				name="site.useremail" value="${eopSite.useremail }" style="width: 133px"></td>
			<th style="width: 102px">营业时间：</th>
			<td>
			<input type="checkbox" value="1" name="site.wt" <c:if test="${eopSite.wt == 1 }">checked</c:if> />&nbsp;&nbsp;
			<input type="text" vtype="text"
				name="site.worktime" value="${eopSite.worktime }" style="width: 163px"></td>
		</tr>
	...
	<tbody>
		<tr>
			...
			<td><input type="text" vtype="text"
				name="site.icp" value="${eopSite.icp }" style="width: 176px"><span class="notice-inline">此处填写您在工信部备案管理网站申请的备案编号，详请登陆<a
		...
		<tr>
			...
			<td><span id="el-e927a-51407"><input type="text" vtype="text" isrequired="true" dataType="string"
				name="site.address" value="${eopSite.address }" style="width: 519px"></span></td>
		</tr>
		<tr>
			<th style="height: 34px">邮政编码：</th>
			<td style="height: 34px">
			<input type="text" vtype="text" isrequired="true" dataType="zipcode"
				name="site.zipcode" id="el-e927a-babcf4" value="${eopSite.zipcode }"
				autocomplete="off"></td>
		</tr>
		<tr>
			...
			<input type="text" vtype="text" isrequired="true" dataType="string"
				name="site.linkman" id="el-e927a-babcf4" value="${eopSite.linkman }"
				autocomplete="off"></td>
		</tr>
		<tr>
			...
			<td style="height: 34px">
			<input type="text" vtype="text" isrequired="true" dataType="string"
				name="site.linktel" value="${eopSite.linktel }"
				autocomplete="off"></td>
		</tr>
		<tr>
			...
			<td style="height: 34px">
			<input type="text" vtype="text" isrequired="true" dataType="email"
				name="site.email" value="${eopSite.email }"
				autocomplete="off"></td>
		</tr>
		<tr>
			<th>开启站点：</th>
			<td>
			<input type="radio" name="site.siteon" namespace="siteon" id="eopsiteon0"
				default="0" <c:if test="${eopSite.siteon==0 }">checked="checked"</c:if> value="0"><label
				for="eopsiteon0">是</label>&nbsp;<input type="radio"
				name="site.siteon" id="eopsiteon1"
		...
		<tr>
			<th>关闭原因：</th>
			<td>
			<textarea style="width:519px;height:200px" name="site.closereson">${eopSite.closereson }</textarea>
			</td>
		</tr>		
	</tbody>
</table>
