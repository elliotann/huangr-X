...
<table class="form-table">
	<tr>
		<th> <input type="hidden"
			name="JEAPUserDetail.userid" id="JEAPUserDetail.userid"
			value="${userid }" /><label class="text">经营范围：</label></th>
		<td><input type="text" name="JEAPUserDetail.bussinessscope"
			id="JEAPUserDetail.bussinessscope"
			value="${eopUserDetail.bussinessscope }" 
			dataType="string" isrequired="true" style="width:260px;" /></td>
	</tr>
	<tr>
		<th><label class="text">注册地：</label></th>
		<td><input type="text" name="JEAPUserDetail.regaddress"
			id="JEAPUserDetail.regaddress" value="${eopUserDetail.regaddress }"
			 dataType="string" isrequired="true" style="width:260px;" /></td>
	</tr>
	<tr>
		<th><label class="text">注册日期：</label></th>
		<td><input type="text" name="JEAPUserDetail.regdate"
			id="JEAPUserDetail.regdate" value="${eopUserDetail.regdate }"
			 dataType="string" isrequired="true" style="width:260px;"/></td>
	</tr>
	<tr>
		<th><label class="text">公司规模：</label></th>
		<td><select name="JEAPUserDetail.corpscope"
			id="JEAPUserDetail.corpscope">
			<option value="0"
	...
	<tr>
		...
		<td><fck:editor basePath="${ctx}/editor/fckeditor/" startupFocus="false"
							id="JEAPUserDetail.corpdescript" width="98%" height="300" toolbarSet="Default">
