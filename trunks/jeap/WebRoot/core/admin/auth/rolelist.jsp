...
<script type="text/javascript" src="/esf/adminthemes/default/js/plug-in/jquery/jquery-1.8.3.js"></script>
<script type="text/javascript" src="js/Role.js"></script>
<script type="text/javascript" src="/esf/adminthemes/default/js/plug-in/lhgDialog/lhgdialog.min.js"></script>
<script type="text/javascript" src="/esf/adminthemes/default/js/plug-in/tools/curdtools.js"></script>
<div class="grid">
	<div class="toolbar">
		<ul>
			<li><a href="javascript:void(0);" onclick="addRole('新增角色','../core/admin/role.do?add','',900,600);">添加</a></li>
		</ul>
