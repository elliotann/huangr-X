...
<script src="/jeap/form/config/formold.js" type="text/javascript"></script>
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit" >
        <tr>
            ...
            <td align="left" class="l-table-edit-td">
                <input name="tableName" type="text" id="tableName" ltype="text" value="${form.tableName}"  validate="{required:true,maxlength:30}" />
            </td>
            <td align="right" class="l-table-edit-td">注释:</td>
            <td align="left" class="l-table-edit-td">
                <input name="tableTitle" type="text" id="tableTitle" ltype="text" value="${form.tableTitle}"  validate="{required:true,maxlength:60}" />
            </td>
        </tr>
    </table>
    <br />
