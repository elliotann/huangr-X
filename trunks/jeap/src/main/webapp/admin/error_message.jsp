...
<form id="errorform" action="http://www.easysoft.com/esf/errorReport.do" method="post">
<div    class='success'  style="height:200px">
	 
	  <h4>哎呀，esf出现了一个意外的错误:(<br/></h4>
	     
  <div style="clear:both;"> 
  
        <p>
        
   你愿意将这个错误提交给我们吗？ 这会使esf更加完善、稳定！
...
$(function(){
	...
	$("#sendBtn").click(function(){
		...
		$("#errorform").ajaxSubmit({
				url :"<%=request.getContextPath() %>/core/admin/errorReport!proxy.do?ajax=yes",
					type : "POST",
					dataType : 'html',
