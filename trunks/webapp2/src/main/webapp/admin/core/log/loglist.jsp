	...
	<form id="orderform">
		<div class='buttonArea'>
			<div style="float:left;">
			 ...
			 <span style="float: right;height:28px;"> 
				...
				<input id="searchKeyword" class="input_text b_fr mr5" type="text" value="" size="30" placeholder="请操作员" name="searchKeyWord" />
			</span>
		</div>
		...
		<div class="shadowBoxWhite tableDiv">
			<table class="easyui-datagrid"
				data-options="url:'buslog.do?dataGrid&ajax=yes',pageList: [5,10,15,20],pageSize:30,fitColumns:'true',queryParams:{'complete':''}"
				...
				<thead>
					<tr>
						...
						<th data-options="field:'operator',width:50,align:'center'">操作员</th>
						<th data-options="field:'logTime',width:50,align:'center'">操作时间</th>
						<th data-options="field:'system',width:50,align:'center'">系统</th>
						<th data-options="field:'message',width:50,align:'center'">操作内容</th>
					</tr>
				</thead>
			</table>
		</div>
