	...
	<form method="POST">
		<grid:grid from="componentList">
			...
			<grid:body item="component">
				<grid:cell>
				<b><img class="imgTree"   src="../../admin/images/sitemapclosed.gif" status="close">${component.name }</b>
...
$(function(){
	...
	$(".imgTree").click(function(){
		...
		if(status=='close')  {
			...
			$this.attr("src","../../admin/images/sitemapopened.gif");
			
		}else if(status=='open'){
			$this.attr("status","close");
			$this.attr("src","../../admin/images/sitemapclosed.gif");
