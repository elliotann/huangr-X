    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit" >
        <tr>
            ...
            <td align="left" class="l-table-edit-td">
                <input name="projectPath" type="text" id="projectPath" class="form-control"  validate="{required:true,maxlength:60}" />
            </td>
            <td align="left"></td>
        </tr>
        <tr>
            ...
            <td align="left" class="l-table-edit-td">
                <input name="tableNameLabel" type="text" id="tableName" class="form-control" value="${formEntity.tableName}"  disabled="disabled" />
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td">
                <input name="packageName" type="text" id="packageName" class="form-control"  validate="{required:true,maxlength:60}" />
            </td>
            <td align="left"></td>
        </tr>
        <tr>
            ...
            <td align="left" class="l-table-edit-td">
                <input name="entityName" type="text" id="entityName" class="form-control" value="${entityName}"  validate="{required:true,maxlength:60}" />
            </td>
            <td align="left"></td>
        </tr>
        <tr>
