...
<body>
	<table cellpadding="0" cellspacing="0" class="l-table-edit" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td">
                <input name="tableName" type="text" id="tableName"   validate="{required:true,maxlength:30}" class="form-control"  value="${form.tableName }"/>
            </td>
            <td align="right" class="l-table-edit-td">表单名称:</td>
            <td align="left" class="l-table-edit-td">
                <input name="formName" type="text" id="formName"  validate="{required:true,maxlength:60}" class="form-control" value="${form.formName }"/>
            </td>
        </tr>
    </table>
